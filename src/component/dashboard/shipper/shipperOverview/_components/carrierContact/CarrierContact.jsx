...
const InfoBlock = ({ label, value }) => (
  <div className="flex flex-col gap-2">
    ...
    <p className="text-sm font-medium text-[18.5px] robReg text-gray-900">{value}</p>
  </div>
);
...
<div className="grid grid-cols-2 mt-6 w-[40vw] ">
      ...
      <div className="bg-white border robReg rounded-xl p-6 space-y-4">
        ...
        <ol className="text-sm text-gray-600 space-y-2 list-decimal list-inside bg-gray-50 p-4 rounded-lg">
          <li>
            The carrier agrees to transport the shipment from the origin
            to the destination as specified.
          </li>
          <li>
          ...
          <li>
            The carrier is responsible for the safety and timely delivery
            of the shipment.
          </li>
          <li>
      ...
      <div className="flex gap-4">
        <button className="w-full border bg-white py-4 rounded-xl">Cancel</button>
