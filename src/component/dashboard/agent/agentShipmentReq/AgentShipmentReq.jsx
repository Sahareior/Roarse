...

{
    [1,2,3,4,5].map(items => (
                ...
                <div className='flex items-center gap-4'>
                   ...
                   <Link to='/dashboard/agent-dashboard/shipment-req/:shipmentReqId'>
...
const CarrierShipmentReq = () => {
    const location = useLocation()
    return (
        <div>
            {
                location.pathname === '/dashboard/agent-dashboard/shipment-req' ? (
                    <div>
...
export default CarrierShipmentReq;