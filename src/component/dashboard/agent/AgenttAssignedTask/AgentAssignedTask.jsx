...

{
    [1,2,3,4,5].map(items => (
                ...
                <div className='flex items-center gap-4'>
                   ...
                   <Link to='/dashboard/agent-dashboard/assinged-tasks/:agentAssignedTask'>
...
const CarrierAssignedTask = () => {
    const location = useLocation()
    return (
        <div>
            {
                location.pathname === '/dashboard/agent-dashboard/assinged-tasks' ? (
                    <div>
...
export default CarrierAssignedTask;;