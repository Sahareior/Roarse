...
const IncomingShipmentDetails = () => {
  ...
  const { incomingId } = useParams();

  return (
    <div>
      {location.pathname ===
      "/dashboard/carrier-dashboard/incoming-shipments/:incomingId" ? (
        <div className="max-w-8xl bg-white mx-auto p-6 space-y-6">
            ...
            <div className="lg:col-span-2 border p-6 rounded-xl space-y-3">
              ...
              <div className="  rounded-xl p-5">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <InfoItem label="Expected Delivery" value="Within 2–3 days" />
                </div>
              </div>
              ...
              <div className="bg-[#EFF6FF] border border-blue-200 rounded-xl p-7 flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[15px] robReg text-[#1C398E]">Payment</p>
                ...
                <p className="text-[22px] robReg text-[#1C398E]">$12,500</p>
              </div>
            </div>
          ...
          <div className="flex  gap-8 pt-4">
            ...
            <div className="flex gap-7">
              <Link
                to={`/dashboard/carrier-dashboard/incoming-shipments/${incomingId}/chat`}
              >
