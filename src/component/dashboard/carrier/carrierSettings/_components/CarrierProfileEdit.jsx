...
<div className="p-6 space-y-6">
  ...
  {activeTab === "company" && (
    <>
      <p className="text-sm font-medium">Company Information (Optional)</p>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <InputField label="Company Name" placeholder="Global Express Logistics" />
        <SelectField label="Business Type">
          <option>LLC</option>
          {/* Add more options as needed */}
        </SelectField>
        <InputField label="Tax ID (EIN)" placeholder="12-3456789" />
        <InputField label="DOT License Number" placeholder="DOT-123456" />
        <InputField label="Insurance Provider" placeholder="American Transport Insurance" />
        <InputField label="Insurance Policy Number" placeholder="ATI-789456123" />
        <InputField 
