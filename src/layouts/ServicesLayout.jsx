...
const ServicesLayout = () => {
    ...
    let subTitle = 'Comprehensive logistics solutions for all your shipping needs';
   let featrureData =[]
   let featureTitle
   let featureDes
    ...
    if (location.pathname === '/Carrier') {
        ...
        subTitle = 'Find profitable loads, reduce empty miles, and grow your business with AI-powered load matching and route optimization. Join 50,000+ drivers earning more with Roarse.';
       ...
       featureDes='Everything you need to run a successful trucking business'
        ...
        featureDes='Everything you need to manage your freight operations efficiently'
        title = 'Ship Smarter, Save More';
        subTitle = 'Connect with verified carriers instantly, track shipments in real-time, and reduce freight costs with AI-powered logistics management. Everything you need to streamline your shipping operations.';
    ...
    return (
        <div>
            ...
            />
            <SpecifiicHero />
            <Features featureData={featrureData} title={featureTitle} subTitle={featureDes} />
            <HowItsWork />
